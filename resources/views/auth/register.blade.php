    ...
    <div class="col-md-6">
        <div class="text-center mb-2">
            <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300"
                data-imageid="authentication-two-color-b35f8" imageName="Authentication" class="illustrations_image"
                style="width: 151px;">
                ...
                <circle cx="129.81" cy="83.38" r="3.73" fill="#7468fd" class="target-color" />
                <circle cx="140.26" cy="83.38" r="3.73" fill="#ffd200" />
                <path d="M90.63,247.68s-1.89,2.68-4.64,2.17-4.17,1.93-1.94,3.28,9.31-.06,9.31-.06l.89-3.93Z"
                    fill="#7468fd" class="target-color" />
                <path d="M139.12,131.19s10.06.05,13.21,20.78,6.92,55.15-27.78,55.51h0V182.85Z" fill="#a5a5a5"
                    opacity="0.4" />
                <path
                ...
                <path d="M118.78,236.28s2.44,2.19,1.6,4.86,1.41,4.38,3,2.33,1.08-9.25,1.08-9.25l-3.79-1.36Z"
                    fill="#7468fd" class="target-color" />
                <path
                ...
                <rect x="187.1" y="104.57" width="38.9" height="31.01" fill="#7468fd" class="target-color" />
                <path
                ...
                <rect x="47.78" y="184.3" width="11.07" height="19.11"
                    transform="translate(-138.85 134.73) rotate(-57.52)" fill="#ffd200" />
                ...
                <path d="M50,172.67S21.64,64.48,84,33.5c14.08-7,103.19-25,187.38,18.17" fill="none" stroke="#000"
                    stroke-linecap="round" stroke-linejoin="round" stroke-width="2" stroke-dasharray="2 10"
                    opacity="0.12" />
                <path d="M322.33,241.51s-8.51-2.33-10.36-10.26c0,0,13.19-2.66,13.56,11Z" fill="#7468fd" opacity="0.58"
                    class="target-color" />
                <path d="M323.38,240.66s-5.95-9.4-.72-18.2c0,0,10,6.37,5.58,18.22Z" fill="#7468fd" opacity="0.73"
                    class="target-color" />
                <path d="M324.91,240.67s3.14-9.93,12.64-11.82c0,0,1.79,6.45-6.15,11.84Z" fill="#7468fd"
                    class="target-color" />
                ...
                <polyline points="291.17 82.5 297.35 92.78 312.17 73.22" fill="none" stroke="#fff"
